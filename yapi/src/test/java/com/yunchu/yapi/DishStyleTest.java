...
public class DishStyleTest {
	...
	@Autowired
	YcFoodMapper ycFoodMapper;

	public static final String TEMP_INSERT = "INSERT INTO yc_dish_style ( code, cnname, p_id ) VALUES ( '%s', '%s', '%s' );";

	@Test
	public void insertData() {
		// String data = "烧 炒 爆 焖 炖 蒸 煮 拌 烤 炸 烩 溜 氽 腌 卤 炝 煎 酥 扒 熏 煨 酱 煲 烘焙 火锅 砂锅
		// 拔丝 生鲜 调味 技巧 烙 榨汁 冷冻 焗 焯 干煸 干锅 铁板 微波 其他";
	...
	public void inserColor() {
		...
		// String colors =
		// "[{\"title\":\"嫣红\",\"name\":\"red\",\"color\":\"#e54d42\"},{\"title\":\"桔橙\",\"name\":\"orange\",\"color\":\"#f37b1d\"},{\"title\":\"明黄\",\"name\":\"yellow\",\"color\":\"#fbbd08\"},{\"title\":\"橄榄\",\"name\":\"olive\",\"color\":\"#8dc63f\"},{\"title\":\"森绿\",\"name\":\"green\",\"color\":\"#39b54a\"},{\"title\":\"天青\",\"name\":\"cyan\",\"color\":\"#1cbbb4\"},{\"title\":\"海蓝\",\"name\":\"blue\",\"color\":\"#0081ff\"},{\"title\":\"姹紫\",\"name\":\"purple\",\"color\":\"#6739b6\"},{\"title\":\"木槿\",\"name\":\"mauve\",\"color\":\"#9c26b0\"},{\"title\":\"桃粉\",\"name\":\"pink\",\"color\":\"#e03997\"},{\"title\":\"棕褐\",\"name\":\"brown\",\"color\":\"#a5673f\"},{\"title\":\"玄灰\",\"name\":\"grey\",\"color\":\"#8799a3\"},{\"title\":\"草灰\",\"name\":\"gray\",\"color\":\"#aaaaaa\"},{\"title\":\"墨黑\",\"name\":\"black\",\"color\":\"#333333\"},{\"title\":\"雅白\",\"name\":\"white\",\"color\":\"#ffffff\"}]";
		// List<Map<String, Object>> list =
		// GsonUtil.GsonToListGsonObject(colors);
		// String jiLu = "";
		// List<YcDishStyle> ycDishStyles = ycDishStyleMapper.selectList(new
		// QueryWrapper<YcDishStyle>().eq("1", "1"));
		...
		// System.out.println("index:" + i + " 次数:" + this.countString(jiLu,
		// "-"+ i +"-"));
		// }
	...
	@Test
	public void inserSean() {
		File file = new File("/Users/cott.wen/Desktop/tiaoliao.txt");
		int lineNo = 0;
		int line = 0;
		try {
			...
			while ((s = br.readLine()) != null) {// 使用readLine方法，一次读一行
				...
				YcFood entity = new YcFood();
				entity.setCnname(name);
				entity.setStatus(5);
				lineNo += this.ycFoodMapper.insert(entity);
			}
			br.close();
		} catch (Exception e) {
			log.info(e);
